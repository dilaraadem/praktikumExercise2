...
public class AttributesOSM extends Attributes {
	...
	private String sirGroupModel = "org.vadere.simulator.models.groups.sir.SIRGroupModel";
	private List<String> submodels = new LinkedList<>();

	public AttributesOSM() {
		submodels.add(getSirGroupModel());
	}
	...
	public String getSirGroupModel() {
		return sirGroupModel;
	}
}
